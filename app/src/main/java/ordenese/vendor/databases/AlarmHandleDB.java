...
public class AlarmHandleDB extends SQLiteOpenHelper {

    private final static String name = "AlarmHandleDataBase";
    private final static int version = 1;
    private final static String TABLE_NAME = "alarm_handle_table";
    ...
    private static AlarmHandleDB sInstance;

    public static synchronized AlarmHandleDB getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new AlarmHandleDB(context.getApplicationContext());
        }
        return sInstance;
    }

    private AlarmHandleDB(Context context) {
