                            ...
                            if (response.isSuccessful()) {
                                ...
                                if (categoryDataSet != null) {
                                    if (categoryDataSet.getCategory().size() != 0) {
                                        ...
                                        get_sub_category(categoryDataSet.getCategory().get(0).category_id, 0);
                                    } else {
        ...
        if (getActivity() != null) {
            if (Constant.isNetworkAvailable()) {
                ...
                try {
                    ...
                    retrofitInterface = ApiClientGson.getClient().create(ApiInterface.class);
                    Call<SubCategoryDataSet> Call = retrofitInterface.subcategory(Constant.DataGetValue(activity, Constant.Token), body);
                    mProgressDialog.show();
        ...
        if (getActivity() != null) {
            if (Constant.isNetworkAvailable()) {
                ...
                try {
                    ...
                    jsonObject.put("sub_category_id", sub_category_id);
                               ...
                               /* setOnLoadMoreListener(() -> {
                                    ...
                                    if (page <= ((total / 10) + 1)) {
                                        ...
                                        try {
                                            ...
                                            retrofitInterface = ApiClientGson.getClient().create(ApiInterface.class);
                                            Call<GroceryProducts> Call = retrofitInterface.product(body);
                                            mProgressDialog.show();
                                            Call.enqueue(new Callback<GroceryProducts>() {
                                                @SuppressLint("NotifyDataSetChanged")
                                                @Override
